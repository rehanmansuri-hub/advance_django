...
class FacultyCtl(BaseCtl):
    ...
    def request_to_form(self, request):
        ...
        self.form['qualification'] = request.POST.get('qualification', '').strip()
    ...
    def form_to_model(self, obj):
        ...
        obj.qualification = self.form['qualification']
    ...
    def model_to_form(self, obj):
        ...
        self.form['qualification'] = obj.qualification
    ...
    def input_validation(self, request):
        ...
        if DataValidator.is_null(self.form.get('qualification')):
            input_error['qualification'] = 'Qualification is required'
            input_error['error'] = True
